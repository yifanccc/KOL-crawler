...
class PositionEstimate(Base):
    ...
    entry_price: Mapped[str | None] = mapped_column(String(64))
    mark_price: Mapped[str | None] = mapped_column(String(64))
    notional: Mapped[str | None] = mapped_column(String(64))
    leverage: Mapped[str | None] = mapped_column(String(64))
    position_margin: Mapped[str | None] = mapped_column(String(64))
    estimated_pnl: Mapped[str | None] = mapped_column(String(64))
